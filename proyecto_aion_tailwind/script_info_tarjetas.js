...
function mostrarTexto(cardNumber) {
    ...
    textoSeleccionado.classList.remove('translate-x-0', 'opacity-100'); // Remover la animación de entrada
    textoSeleccionado.classList.add('translate-x-full', 'opacity-0'); // Agregar la animación de salida
    ...
    setTimeout(function() {
        ...
        if (cardNumber === 1) {
            ...
            imagenTexto.src = 'img/diseñoAdaptable.jpg'; // Cambiar la ruta de la imagen
            ...
            imagenTexto.src = 'img/personalizable.jpg'; // Cambiar la ruta de la imagen
            ...
            imagenTexto.src = 'img/soporte.jpg'; // Cambiar la ruta de la imagen
            ...
            imagenTexto.src = 'img/interfaz.png'; // Cambiar la ruta de la imagen
        }

        // Luego, agregar la animación de entrada después de un breve retardo
        textoSeleccionado.classList.remove('translate-x-full', 'opacity-0');
        textoSeleccionado.classList.add('translate-x-0', 'opacity-100');
    }, 500); // El tiempo de espera debe coincidir con la duración de la animación de salida
}
