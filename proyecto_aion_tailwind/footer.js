    ...
    footer.innerHTML = `
        ...
        <div class="bg-gray-900 text-white py-6 px-6">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 mx-auto max-w-screen-xl">
                ...
                <!-- Sección de Aion -->
                <div class="flex flex-col items-start w-full md:w-auto px-8">
        ...
        <div class="bg-[#ff8000] text-black text-sm py-3 px-6">
            <div class="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center px-8">
                <p class="text-sm text-center md:text-left">&copy; 2025 - Todos los derechos reservados</p>
