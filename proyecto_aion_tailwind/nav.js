function loadNav() {
    const navHTML = `
    <header class="bg-gray-200 fixed top-0 left-0 w-full h-16 z-[9999] shadow-md">
        <div class="max-w-screen-xl mx-auto flex items-center h-full px-4">
            <nav class="container mx-auto flex justify-between items-center p-4 relative">
                ...
                <!-- Menú de navegación -->
                <ul id="nav-list" class="hidden lg:flex gap-x-6 absolute top-16 left-0 w-full bg-white lg:bg-transparent lg:static lg:w-auto p-4 lg:p-0 shadow-md lg:shadow-none flex-col lg:flex-row z-50">
