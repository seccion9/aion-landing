...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail1->isHTML(true);
        $mail1->Subject = $nombre . 'Registro completado ';
        $mail1->Body = '<h3>¡Gracias por contactarnos, ' . $nombre . '!</h3>
               <p>Hemos recibido tu solicitud de registro, la hemos tramitado y ha sido completada</p>
               <p>A continuación, te enviamos una copia de los datos que nos proporcionaste:</p>
               <ul>
                   <li><b>Nombre:</b> ' . $nombre . '</li>
                   <li><b>Email:</b> ' . $email . '</li>
                   <li><b>Teléfono:</b> ' . $user . '</li>
               </ul>
               <p>Si necesitas modificar algún dato, no dudes en ponerte en contacto con nosotros.</p>
               <p>A continuacion pruebe ha realizar el ingreso en nuestra web.</p>
               <br>
        ...
        $mail2->isHTML(true);
        $mail2->Subject = 'Nuevo registro de usuario';
